  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='mt-8'>
          ...
          <img className='h-6 mx-5' src={assets.stripe_1} alt='Stripe' />
          </div>
          ...
          <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
           ...
           <p className='text-black text-sm font-medium mx-4'>CASH ON DELIVERY</p>
            ...
            <div className='w-full text-end mt-8'>
              <button type='sumbit'  className='bg-black text-white px-6 py-2 text-sm rounded hover:bg-gray-800 transition-colors duration-200'>
    PLACE ORDER
  </button>
</div>
